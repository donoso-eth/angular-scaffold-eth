...
interface SimpleNftContractInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleNftContract extends BaseContract {
  ...
  interface: SimpleNftContractInterface;
